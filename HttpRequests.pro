...
UBUNTU_TRANSLATION_DOMAIN="httprequests.liu-xiao-guo"
...
aptest.commands = bash $$PWD/HttpRequests/tests/autopilot/run
aptest.depends  = sub-HttpRequests

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/HttpRequests/tests/unit
unittest.depends  = sub-HttpRequests
